...
export function RecommendBusinessDrawer({
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-125 flex-col bg-[#F4F6F8] px-4">
      <header className="grid grid-cols-[40px_1fr_40px] items-center py-3.5">
      ...
      <main className="flex flex-1 flex-col items-center justify-center">
          ...
          <div className="relative rounded-[24px] bg-white p-4">
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <div className="relative">
                <div className="flex h-[96px] w-[96px] items-center justify-center overflow-hidden rounded-full border-4 border-white bg-[#CED7E1] shadow-[0px_4px_16px_0px_#00000033]">
                  {profilePhotoUrl ? (
                    <Image
                      src={profilePhotoUrl}
                      alt="Profile"
                ...
                <div className="absolute -bottom-1 -right-1 rounded-[12px] border-4 border-white bg-white">
                  <Image
        ...
        <div className="mt-6 text-center">
          <h2 className="text-xl font-bold text-black -tracking-[0.4px]">
            Share the gift of firespot
          </h2>
          <p className="mt-1.5 max-w-[360px] text-sm font-medium text-[#00000080]">
            Recommend firespot to a business that would find it useful. You can
            earn money distributing QR kits.
          </p>
        </div>
