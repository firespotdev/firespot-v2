    ...
    <div className="flex h-full min-h-0 flex-col bg-white font-satoshi">
      <header className="flex h-16 shrink-0 items-center border-b border-[#E7E9EC] bg-white px-4 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
        <button
          ...
          className="flex size-9 items-center justify-center text-black transition-colors"
        >
          ...
          {displayedChannels.map((item) => {
            ...
            return (
              <button
                ...
                className="group flex min-h-16 w-full items-center justify-between gap-4 px-4 text-left transition-colors hover:bg-[#FAFAFA] focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#047857]"
              >
                ...
                >
                  {isSelected && (
                    <div className="size-2 rounded-full bg-[#0AA879]" />
                  )}
                </div>
              </button>
            )
      ...
      <div className="shrink-0 border-t border-[#E7E9EC] bg-white p-4">
        <Button
          type="button"
          onClick={handleMakePayment}
          className="min-h-14 w-full rounded-[10px] bg-[#075D4B] text-base font-bold text-white transition-colors hover:bg-[#064D3F] focus-visible:ring-[#075D4B]"
        >
          Make Payment
        </Button>
      </div>
