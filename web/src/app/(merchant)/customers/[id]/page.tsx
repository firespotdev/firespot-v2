...
import { GreenSpinner, showNotificationToast } from '@/components/ui'
      ...
      <div className="mx-auto flex min-h-dvh w-full max-w-125 flex-col px-4 pb-12">
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="mt-6 flex items-center justify-center gap-2">
            <button
              ...
              className="rounded-full bg-black px-6 py-2 text-sm font-medium text-white transition-all hover:bg-black/90"
            >
              Re-engage
            </button>
            <button
              ...
              className="rounded-full bg-[#E5E7EB] px-5 py-2 text-sm font-medium text-black transition-all hover:bg-black/10"
            >
              Message
            </button>
            <button
        ...
        {activeTab === 'history' && (
          <div className="mt-5 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between rounded-[16px] border border-[#F1F1F1] bg-white p-4 shadow-[0px_4px_8px_0px_#0000000A]">
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#F4F6F8]">
            ...
            <div className="flex items-center justify-between rounded-[16px] border border-[#F1F1F1] bg-white p-4 shadow-[0px_4px_8px_0px_#0000000A]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[17px] font-bold leading-tight text-[#E53935]">
            ...
            {Object.keys(groupedSales).length === 0 ? (
              <p className="py-8 text-center text-sm font-medium text-[#00000066]">
                No transactions recorded for this customer yet.
              </p>
            ) : (
              Object.entries(groupedSales).map(([monthYear, monthSales]) => (
                <div key={monthYear} className="mt-3">
                  <h3 className="mb-2 text-sm font-bold text-black">
                    {monthYear}
                  </h3>
                  <div className="overflow-hidden rounded-[16px] border border-[#F1F1F1] bg-white shadow-[0px_4px_8px_0px_#0000000A]">
                    {monthSales.map((sale: any, idx: number) => {
        ...
        {activeTab === 'feedback' && (
          <div className="mt-5 flex flex-col gap-4">
            {Object.keys(groupedFeedback).length === 0 ? (
              <p className="py-8 text-center text-sm font-medium text-[#00000066]">
                No feedback received from this customer yet.
              </p>
            ) : (
