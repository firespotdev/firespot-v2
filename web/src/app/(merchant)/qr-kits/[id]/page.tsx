              ...
              <div className="rounded-xl relative mb-4">
                ...
                >
                  <div className="bg-white p-1 rounded-[0.6rem] relative">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[34px] h-[34px] rounded-full overflow-hidden border-[2.5px] shadow-lg border-white z-10 bg-white">
