...
export function CustomDrawer() {
  ...
  if (fullScreen && drawerDirection === 'bottom') {
    return (
      <DrawerPrimitive
        ...
        direction={drawerDirection}
      >
        <DrawerContent className="max-w-125 mx-auto bg-white rounded-t-3xl data-[vaul-drawer-direction=bottom]:max-h-[80vh]">
          {/* Header */}
  ...
  return (
    <DrawerPrimitive
      ...
      direction={drawerDirection}
    >
      <DrawerContent className="max-w-125 mx-auto bg-white data-[vaul-drawer-direction=bottom]:max-h-[80vh]">
        {/* Header */}
        <DrawerHeader className="flex flex-row items-center justify-between py-1.5 px-4">
          <div className="w-9 h-9 flex items-center justify-center">
            {HeaderLeft && <HeaderLeft />}
