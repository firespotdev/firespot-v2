 ...
 */
const QRKitCard = forwardRef<HTMLDivElement, QRKitCardProps>(
  function QRKitCard({ brandedSvg }, ref) {
    return (
      <div
        ref={ref}
        style={{
        ...
        className="py-6 px-6 rounded-2xl flex flex-col items-center relative w-[300px]"
      >
