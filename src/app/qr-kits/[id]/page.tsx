...
export default function QRKitDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] flex flex-col font-satoshi">
      ...
      <div className=" bg-white py-5 px-4 flex gap-3">
        <div className="">
          {/* Share URL */}
          <div className="flex items-center gap-2 border-b border-[#F1F1F1] pb-5">
            <div className="flex-1 border border-[#DFDFDF] rounded-[30px] px-4 py-2.5">
            ...
            <button
              onClick={handleShare}
              className="flex items-center gap-1.5 px-4 py-2.5 bg-[#F1F1F1] rounded-[30px]"
            >
              <Share className="w-4 h-4 text-black" />
              <span className="text-[10px] font-bold text-black tracking-[1px]">
                SHARE
              </span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-2 border-t border-[#F1F1F1] pt-5 -mx-4 px-4">
            <Button
              variant="destructive"
